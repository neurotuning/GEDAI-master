...
uilist = { ...    
    ...
    {'style' 'text' 'string' 'Leadfield matrix'}    {'style' 'popupmenu' 'string' '          precomputed|          interpolated|          warped|          bayesopt'} ...
...
ref_matrix_cell = {'precomputed', 'interpolated', 'warped', 'bayesopt'};
