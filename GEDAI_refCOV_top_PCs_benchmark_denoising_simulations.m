...
[ALLEEG2(f).data, keptColumnIndices(f,:), zeroedColumnIndices(f,:)] = retainExactPercentageRandomEEGBlocks(ALLEEG2(f).data, contaminated_signal_proportion(c), sample_length/5, 2*sample_length);
